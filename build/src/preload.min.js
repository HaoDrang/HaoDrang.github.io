...
Preload.prototype.initialize = function() {
    ...
    document.body.appendChild(a), a.id = "gameCanvas", a.width = CANVAS_W, a.height = CANVAS_H, 
    console.log("game canvas created...");
    var b = new createjs.Stage(a);
    console.log("stage is ready..."), resizeCanvas(b);
    var c = new createjs.Shape();
    c.graphics.beginFill(createjs.Graphics.getRGB(200, 200, 200, .5)).drawRect(0, 0, a.width, a.height), 
    b.addChild(c), b.update();
};