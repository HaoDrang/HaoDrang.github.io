...
Preload.prototype.initialize = function() {
    ...
    this.buildUI(b), document.addEventListener("resize", resizeCanvas(b));
}, Preload.prototype.buildUI = function(a) {
    var b = CANVAS_W - 10, c = 30, d = (CANVAS_W - b) / 2, e = (CANVAS_H - c) / 2;
    progressBar = new PreloadProgressBar(d, e / 2, b, c, 5, 2, 2, 80, 200, 80, 1), a.addChild(progressBar), 
    ...
    this.graphics.beginFill(this.color).drawRoundRect(this.x + this.offsetx, this.y + this.offsety, this.w - 2 * this.offsetx, this.h - 2 * this.offsety, this.radius, this.radius, this.radius, this.radius), 
